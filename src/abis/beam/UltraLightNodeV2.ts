export default [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "address", name: "lib", type: "address" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bytes32", name: "uln", type: "bytes32" },
    ],
    name: "SetRemoteUln",
    type: "event",
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint16", name: "outboundProofType", type: "uint16" },
      {
        internalType: "uint64",
  ...
  },
  {
    inputs: [
      { internalType: "uint16", name: "_chainId", type: "uint16" },
      { internalType: "uint16", name: "_proofType", type: "uint16" },
    ],
    name: "enableSupportedOutboundProof",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    name: "nonceContract",
    outputs: [
      { internalType: "contract NonceContract", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint16", name: "_outboundProofType", type: "uint16" },
      {
        internalType: "uint64",
  ...
  {
    inputs: [
      { internalType: "address", name: "_layerZeroToken", type: "address" },
    ],
    name: "setLayerZeroToken",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      { internalType: "uint16", name: "_remoteChainId", type: "uint16" },
      { internalType: "bytes32", name: "_remoteUln", type: "bytes32" },
    ],
    name: "setRemoteUln",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bytes32", name: "_lookupHash", type: "bytes32" },
      { internalType: "uint256", name: "_confirmations", type: "uint256" },
      { internalType: "bytes32", name: "_blockData", type: "bytes32" },
    ],
    name: "updateHash",
    outputs: [],
    stateMutability: "nonpayable",
