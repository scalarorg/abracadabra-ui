export default [
  ...
  },
  {
    ...
    name: "frontEnds",
    outputs: [
      { internalType: "uint256", name: "kickbackRate", type: "uint256" },
  ...
  {
    inputs: [{ internalType: "address", name: "_frontEnd", type: "address" }],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_kickbackRate", type: "uint256" },
    ],
