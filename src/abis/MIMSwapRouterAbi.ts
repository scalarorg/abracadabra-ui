export default [
  {
    inputs: [
      ...
      { internalType: "contract IFactory", name: "factory_", type: "address" },
    ],
    stateMutability: "nonpayable",
    type: "constructor",
  },
  { inputs: [], name: "ErrBadPath", type: "error" },
  { inputs: [], name: "ErrDecimalsDifferenceTooLarge", type: "error" },
  { inputs: [], name: "ErrEmptyPath", type: "error" },
  { inputs: [], name: "ErrExpired", type: "error" },
  { inputs: [], name: "ErrInTokenNotETH", type: "error" },
  { inputs: [], name: "ErrInvalidBaseToken", type: "error" },
  { inputs: [], name: "ErrInvalidQuoteTarget", type: "error" },
  { inputs: [], name: "ErrInvalidQuoteToken", type: "error" },
  { inputs: [], name: "ErrNotETHLP", type: "error" },
  { inputs: [], name: "ErrOutTokenNotETH", type: "error" },
  { inputs: [], name: "ErrPathTooLong", type: "error" },
  {
    inputs: [{ internalType: "uint256", name: "amountOut", type: "uint256" }],
    name: "ErrTooHighSlippage",
    type: "error",
  },
  { inputs: [], name: "ErrTooLargeDecimals", type: "error" },
  { inputs: [], name: "ErrUnknownPool", type: "error" },
  { inputs: [], name: "ErrZeroAddress", type: "error" },
  { inputs: [], name: "ErrZeroDecimals", type: "error" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "minimumShares", type: "uint256" },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "baseRefundAmount", type: "uint256" },
      { internalType: "uint256", name: "quoteRefundAmount", type: "uint256" },
    ],
    stateMutability: "nonpayable",
    type: "function",
  },
    ...
    inputs: [
      {
        components: [
          { internalType: "address", name: "lp", type: "address" },
          { internalType: "address", name: "to", type: "address" },
          { internalType: "bool", name: "inAmountIsBase", type: "bool" },
          { internalType: "uint256", name: "inAmount", type: "uint256" },
          { internalType: "uint256", name: "inAmountToSwap", type: "uint256" },
          { internalType: "uint256", name: "minimumShares", type: "uint256" },
          { internalType: "uint256", name: "deadline", type: "uint256" },
        ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "to", type: "address" },
      { internalType: "uint256", name: "sharesIn", type: "uint256" },
      { internalType: "uint256", name: "minimumBaseAmount", type: "uint256" },
      { internalType: "uint256", name: "minimumQuoteAmount", type: "uint256" },
      { internalType: "uint256", name: "deadline", type: "uint256" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "to", type: "address" },
      { internalType: "uint256", name: "sharesIn", type: "uint256" },
      { internalType: "uint256", name: "minimumETHAmount", type: "uint256" },
      { internalType: "uint256", name: "minimumTokenAmount", type: "uint256" },
      { internalType: "uint256", name: "deadline", type: "uint256" },
    ],
    name: "removeLiquidityETH",
    outputs: [
      { internalType: "uint256", name: "ethAmountOut", type: "uint256" },
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "lp", type: "address" },
      { internalType: "address", name: "to", type: "address" },
      { internalType: "bool", name: "withdrawBase", type: "bool" },
      { internalType: "uint256", name: "sharesIn", type: "uint256" },
