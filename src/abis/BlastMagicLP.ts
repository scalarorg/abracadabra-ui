export default [
  ...
  { inputs: [], name: "ErrBaseQuoteSame", type: "error" },
  { inputs: [], name: "ErrExpired", type: "error" },
  { inputs: [], name: "ErrFlashLoanFailed", type: "error" },
  { inputs: [], name: "ErrInitialized", type: "error" },
  { inputs: [], name: "ErrInvalidI", type: "error" },
  { inputs: [], name: "ErrInvalidK", type: "error" },
  { inputs: [], name: "ErrInvalidLPFeeRate", type: "error" },
  { inputs: [], name: "ErrInvalidSignature", type: "error" },
  { inputs: [], name: "ErrInvalidTargets", type: "error" },
  { inputs: [], name: "ErrIsZero", type: "error" },
  { inputs: [], name: "ErrMintAmountNotEnough", type: "error" },
  { inputs: [], name: "ErrNoBaseInput", type: "error" },
  { inputs: [], name: "ErrNotAllowed", type: "error" },
  { inputs: [], name: "ErrNotAllowedImplementationOperator", type: "error" },
  { inputs: [], name: "ErrNotClone", type: "error" },
  { inputs: [], name: "ErrNotEnough", type: "error" },
  { inputs: [], name: "ErrNotImplementation", type: "error" },
  { inputs: [], name: "ErrNotImplementationOwner", type: "error" },
  { inputs: [], name: "ErrNotPaused", type: "error" },
  { inputs: [], name: "ErrOverflow", type: "error" },
  { inputs: [], name: "ErrReserveAmountNotEnough", type: "error" },
  { inputs: [], name: "ErrSellBackNotAllowed", type: "error" },
  { inputs: [], name: "ErrWithdrawNotEnough", type: "error" },
  { inputs: [], name: "ErrZeroAddress", type: "error" },
  { inputs: [], name: "ErrZeroQuoteAmount", type: "error" },
  { inputs: [], name: "ErrZeroQuoteTarget", type: "error" },
  ...
  },
  {
    inputs: [],
    name: "implementation",
    outputs: [{ internalType: "contract MagicLP", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "assetTo", type: "address" },
      { internalType: "uint256", name: "newLpFeeRate", type: "uint256" },
      { internalType: "uint256", name: "newI", type: "uint256" },
      { internalType: "uint256", name: "newK", type: "uint256" },
      { internalType: "uint256", name: "baseOutAmount", type: "uint256" },
      { internalType: "uint256", name: "quoteOutAmount", type: "uint256" },
  ...
  {
    inputs: [
      { internalType: "uint112", name: "baseTarget", type: "uint112" },
      { internalType: "uint112", name: "quoteTarget", type: "uint112" },
    ],
    name: "setTargets",
    outputs: [],
    stateMutability: "nonpayable",
