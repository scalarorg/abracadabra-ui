export default [
  ...
  { inputs: [], name: "WithdrawMoreThanMax", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  {
    inputs: [{ internalType: "address", name: "harvester", type: "address" }],
    name: "harvest",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
