export default [
  ...
  { inputs: [], name: "OnlyRateLimiter", type: "error" },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "amountCanBeSent", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    name: "rateLimits",
    outputs: [
      { internalType: "uint256", name: "amountInFlight", type: "uint256" },
  ...
  {
    inputs: [
      { internalType: "address", name: "_rateLimiter", type: "address" },
    ],
    name: "setRateLimiter",
    outputs: [],
    stateMutability: "nonpayable",
