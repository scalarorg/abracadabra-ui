export default [
  {
    inputs: [
      { internalType: "contract IBentoBoxV1", name: "box", type: "address" },
      { internalType: "contract IERC20", name: "mim", type: "address" },
    ],
    stateMutability: "nonpayable",
    type: "constructor",
  },
  { inputs: [], name: "ErrOrderAlreadyExists", type: "error" },
  { inputs: [], name: "ErrOrderDoesNotExist", type: "error" },
  { inputs: [], name: "ErrOrderNotFromUser", type: "error" },
  { inputs: [], name: "ErrWhitelistedBorrowExceeded", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bool", name: "close", type: "bool" },
    ],
    name: "LogWithdrawFromOrder",
    type: "event",
  },
  {
    anonymous: false,
  ...
  {
    inputs: [],
    name: "ACTION_WITHDRAW_FROM_ORDER",
    outputs: [{ internalType: "uint8", name: "", type: "uint8" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    name: "orders",
    outputs: [
      { internalType: "contract IGmRouterOrder", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
